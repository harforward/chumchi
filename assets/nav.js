  ...
  const html = `
    ...
    <div class="sidebar" id="sidebar">
      ...
      <nav class="sidebar-nav">
        ...
        <span class="sidebar-section">Family</span>
        <a class="sidebar-item" href="javascript:spoonNav('${root}platform/register.html?flow=join')">
          <span class="icon">+</span> Add a Family Member
        </a>
